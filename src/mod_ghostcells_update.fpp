...
!!even though things are present and everything, when you comments out
!!any of the $acc lines above things dont work anymore ...
...
!      end subroutine bc_fill_prolong
      ...
      subroutine bc_prolong(igrid,i1,i2,i3,iib1,iib2,iib3)
        ...
        if(ghost_copy) then
          ...
          !todojesse this is where the code terminates when the acc
          !loops are fixed ...
