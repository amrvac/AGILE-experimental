...
An example print is shown below, which was made from the AGILE simulation presented in `Pinwheels in the sky, with dust: 3D modelling of the Wolf-Rayet 98a environment', see [doi:10.1093/mnras/stw1289](http://dx.doi.org/10.1093/mnras/stw1289).
